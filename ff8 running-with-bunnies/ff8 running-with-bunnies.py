...
# solution from https://github.com/n3a9/google-foobar/blob/master/Level%204/running_with_bunnies/solution.py
# dont like the problem explanation, imma submit this directly to see further questions 
# much love
